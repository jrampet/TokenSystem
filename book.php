...
<body style="background-image:url(images/bookback.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> Token Booking </strong>Appointment Booking System</a></li>
...
if(1){
	...
	if ($result=mysqli_query($conn,$sq))
		...
		$GLOBALS['rowcount']=mysqli_num_rows($result);
		//echo $rowcount;
...
if(isset($_POST['submit']))
{
		...
		$sql = "INSERT INTO book (BID,Username,Fname,Gender,CID,DID,DOV,Timestamp,Status) 
		VALUES ('$bid','$username','$fname','$gender','$cid','$did','$dov','$timestamp','$status') ";
