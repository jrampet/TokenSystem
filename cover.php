...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> Token Booking </strong>Appointment Booking System</a></li>
					<li><a href="locateus.php">Locate Us</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<h1>Token Booking</h1><br>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					...
					<li><a href="admin/dlogin.php">Doctor Login</a></li>
				</ul>
			</div>
